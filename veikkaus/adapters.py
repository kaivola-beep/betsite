    ...
    for race_id in race_ids:
        ...
        for r in runners:
            ...
            rows.append({
                ...
                "horse_name": _first_key(r, "horseName", "name"),
                "driver_id": _first_key(r, "driverId", "driver_id"),
                "driver_name": _first_key(r, "driverName", "driver", "kuski"),
                "trainer_id": _first_key(r, "trainerId", "trainer_id"),
                "trainer_name": _first_key(r, "trainerName", "trainer", "valmentaja"),
                # Capture any possible pre-mapped Hippos ID the API may expose
                "hippo_horse_id": _first_key(r, "hippoHorseId", "registryHorseId",
